...
### 3\. Professional Thermal Visualization
...
Early iterations faced "thermal runaway" (infinite temperature spikes). This was solved by:

  * Implementing strict clamping on heat transfer rates per frame.
